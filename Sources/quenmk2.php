        ...
        if(isset($_POST['doi'])){
            foreach($depot as &$value){
                if($value['userName']==$userName){
                    ...
                    if($_POST['Newmkc2']==$_POST['Anewmkc2'] && $_POST['mk_quenmk2']==$value['password']&&!isset($error21)){
                        $newmk2 = $_POST['Newmkc2'];
                        $sqlUmk = "update users set mk2 = '$newmk2' where userName = '$userName'";
                        mysqli_query($conn,$sqlUmk);
                        $tc = "Successfully✓ Lấy lại khẩu cấp 2 thành công.";
                        break;
                    }
                    else
                        $tb = "Mật khẩu đăng nhập không đúng.
    ...
    ?>
        ...
        <p id = "title-login">Quên mật khẩu cấp 2</p>
<style>
    d{
    color:#f15626;
    }
    ...
    e{
        ...
        //         if(isset($error21)) 
                    ...
                    echo "<p class = 'error'>$tb</p>";
                }
           ?>
        <form method = "POST" action = "" class="form-horizontal" role="form">
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-4 control-label">Mật khẩu đăng nhập:</label>
                <div class="col-sm-8">
                <input type="text" class="form-control ip-dknh" name = "mk_quenmk2" id="inputEmail3" required placeholder="Mật khẩu đăng nhập hiện tại">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                <input type="number" class="form-control ip-dknh" name = "Newmkc2" id="inputPassword3" placeholder="Nhập mật khẩu cấp 2 mới(Chỉ nhập số )">
                <?php
                if(isset($error21)) 
				    echo '<p class = "error">' .$error21.'</p>';
			    ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                <input type="number" class="form-control ip-dknh" name = "Anewmkc2" id="inputPassword3" placeholder="Nhập lại mật khẩu cấp 2 mới(Chỉ nhập số )">
                </div>
            </div>
            ...
            <div class="form-group">
                <div style = "text-align: center;" class="col-sm-offset-2 col-sm-10">
                    ...
                    <br>+) Không nên đặt mật khẩu dễ đoán.
