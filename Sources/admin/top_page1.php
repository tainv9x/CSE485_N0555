                        ...
                        // }
                            if(isset($sodu)){
                                echo "<div style = 'margin-top: 11px;' class = 'col-xs-3 col-md-3'>
                                    <p><img src = '../icon_sodu.png' style = 'width: 25px; height: 25px;' > ";
                ...
                <div style = "background: #fff;border: 1px solid #f4f4f4;" class = "row">
                    <a href = "../index.php">
                        <div style = "margin-top: 19px;margin-bottom: 19px;" class = "col-md-6 col-xs-8">
                            <img id = "logo" src = "../icon2.png">
                        </div>
                    </a>
                    <div style = "margin-top: 11px;" class = "col-md-6 col-xs-4 info-admin">
                        <img src = "../icon_facebook.png"><a style = "color: green;font-weight: bold;" href="https://www.facebook.com/hethong24h.net" target="_blank">  Hệ Thống 24H</a> 
                        <p></p><img src = "../icon_email.png"><a style = "color: green;font-weight: bold;margin-top: 4px;" href="mailto:Admin@hethong24h.net?Subject=Hello 24h" target="_top"> Admin@HeThong24h.Net</a></p>
                    </div>
                </div>
                <div>
                <div class = "row"> <!--menu-->
