<?php
    ...
    $mFrom = 'phongtg62@wru.vn';  //dia chi email cua ban 
    $mPass = '01632487333';       //mat khau email cua ban
    $nTo = 'Phong'; //Ten nguoi nhan
    $mTo = 'windtran411@gmail.com';   //dia chi nhan mail
    $mail             = new PHPMailer();
