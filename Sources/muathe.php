...
?>
            ...
            <div class = "col-md-12 col-xs-5" style="margin-bottom: 20px;font-size: 25px;margin-top: 20px;"><span class="label label-success">Mua thẻ điện thoại Online </span></div>
            <?php 
                if(isset($errornt1))
                    echo $errornt1;
                if(isset($accnt))
            ...
            <form action="muathe.php" method="post" id="fnapthe" name="fnapthe">
               ...
               <div class = "col-md-2 col-xs-4 nha-mang nha-mang-img" id = "vn"><img class = "img-nha-mang" src = "/images/iconvnmb.png"></div>           
               <div class = "col-md-2 col-xs-4 nha-mang nha-mang-img" id = "mb"><img class = "img-nha-mang" src = "/images/iconmobi.png"></div>           
                ...
                <script>
                    $("#vt").click(function(){
                        ...
                        $("option[value='VTT']").attr("selected", true);
                    });
                    $("#vna").click(function(){
                        $(".nha-mang").css("border","1px solid #dcdcdc");
                        $(this).css("border","4px solid #23a076");
                        $("select[name='card_type_id'] option").removeAttr('selected');
                        $("option[value='VNP']").attr("selected", true);
                    });
                    $("#vn").click(function(){
                        $(".nha-mang").css("border","1px solid #dcdcdc");
                        $(this).css("border","4px solid #23a076");
                        $("select[name='card_type_id'] option").removeAttr('selected');
                        $("option[value='VNM']").attr("selected", true);
                    });
                    $("#mb").click(function(){
                        $(".nha-mang").css("border","1px solid #dcdcdc");
                        $(this).css("border","4px solid #23a076");
                        $("select[name='card_type_id'] option").removeAttr('selected');
                        $("option[value='VMS']").attr("selected", true);
                    });
               ...
               <div class = "col-md-12"></div>           
                ...
                <div style = "text-align: right;display: none;" class ="col-md-3 col-xs-12 title-mt"> <p>Loại thẻ:</p></div><div class ="col-md-8 col-xs-12"><select class = "form-control ip-muathe" name="card_type_id" style = "display: none;">
                        ...
                        <div class = "col-md-12"></div>        
                                ...
                                <div style = "text-align: right; display: none" class ="col-md-3 col-xs-12 title-mt"> <p>Mệnh giá:</p></div><div class ="col-md-8 col-xs-12"> <select class = "form-control ip-muathe" class = 'inputs select' name = 'menh-gia' style = " display: none" id = "mg-mua"> 
                                    <option value='10000'>10000 VND</option>
                                    <option value='20000'>20000 VND</option>
                                    <option value='50000'>30000 VND</option>
                             ...
                             <div style = "margin-top: 15px;" class ="col-md-12 col-xs-12"></div>
				...
				<div class ="col-md-12 col-xs-12" style = "text-align: center;margin-top: 10px;"><input class="btn btn-info" type="submit" value="Mua thẻ ngay"/> </div>
