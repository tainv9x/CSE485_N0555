    ...
    <div class = "title-post">
        <p><h1 class="txt-post-title"style="color:#8bc53f"> Thêm thông tin tài khoản ngân hàng ở mục nào?</h1></p>
    </div>
    <div class = "adate">
    ...
    <p>
      <strong>B2:</strong> chọn <a style="color:red">Tài khoản ngân hàng</a>
    </p>
    <p>
