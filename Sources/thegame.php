...
?>
            ...
            <form action="thegame.php" method="post" id="fnapthe" name="fnapthe">
                ...
                <div class = "col-md-2 col-xs-4 nha-mang nha-mang-img" id = "gar"><img class = "img-nha-mang" src = "/images/garena.png"></div>
               <div class = "col-md-2 col-xs-4 nha-mang nha-mang-img" id = "fpt"><img class = "img-nha-mang" src ="/images/gate.png"></div>    
               <!--<div class = "col-md-2 col-xs-4 nha-mang nha-mang-img" id = "gar"><img class = "img-nha-mang" src = "garena.png"></div>      -->
               <div class = "col-md-2 col-xs-4 nha-mang nha-mang-img" id = "zing"><img class = "img-nha-mang" src = "/images/iconzing.png"></div>           
               <div class = "col-md-2 col-xs-4 nha-mang nha-mang-img" id = "vtc"><img class = "img-nha-mang" src = "/images/iconvcoin.png"></div>           
